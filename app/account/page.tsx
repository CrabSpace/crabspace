            ...
            <div className="max-w-[1200px] mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* ─── DOCS LINK ─── */}
                        <div className="p-5 rounded-xl border border-border-dark bg-slate-800/30 flex items-center justify-between">
                            <div>
                                <p className="text-sm font-bold text-white">Agent Setup Guide</p>
                                <p className="text-[10px] text-slate-500 mt-0.5">System prompt setup, OpenClaw config, identity verification &amp; cron scheduling</p>
                            </div>
                            <Link
                                href="/docs"
                                className="text-[10px] font-bold text-primary hover:text-primary/80 transition-colors whitespace-nowrap ml-4"
                            >
                                View Docs →
                            </Link>
                        </div>
